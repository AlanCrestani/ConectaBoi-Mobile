...
class _CombustivelListPageNewState extends State<CombustivelListPageNew> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: SyncStatusWidget(onTap: () => _showSyncPanel(context)),
          ),
          IconButton(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: SyncStatusWidget(showDetails: true)),
                const SizedBox(width: 8),
                SyncButton(
                  icon: Icons.sync,
                  text: 'Quick Sync',
              ...
              builder: (context, provider, child) {
                ...
                return RefreshIndicator(
                  onRefresh: () async {
                    ...
                    final combustivelProvider = context
                        .read<CombustivelProvider>();
  ...
  List<LancamentoCombustivel> _filtrarLancamentos(
    ...
    if (_dataInicio != null) {
      filtrados = filtrados
          .where(
            (l) =>
                l.data.isAfter(_dataInicio!.subtract(const Duration(days: 1))),
          )
          .toList();
    }
    ...
    if (_dataFim != null) {
      filtrados = filtrados
          .where((l) => l.data.isBefore(_dataFim!.add(const Duration(days: 1))))
          .toList();
    }
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                const DropdownMenuItem(
                  value: null,
                  child: Text('Todos os equipamentos'),
                ),
